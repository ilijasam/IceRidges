...
dateLim.start = datenum('07-Nov-2013');
...
dateLim3.start = datenum('12-Nov-2013 00:00:00');
dateLim3.stop =  datenum('13-Nov-2013 00:00:00');
...
txt1 = text(0.5,2.4,{'AM'},'FontName','times new roman','FontSize',10,'FontWeight','bold');
txt1.Position = [0.02 1.4 0];
txt2 = text(1,2.4,{'DM'},'FontName','times new roman','FontSize',10,'FontWeight','bold');
txt2.Position = [0.95 1.4 0];
...
h_DM = max(locs(   (locs<3)&(pks>0.25)    ));


LI = plot(sp1,sp1.XLim,[h_LI h_LI],'--','Color', 'r', 'LineWidth',2);
DM = plot(sp1,sp1.XLim,[h_DM h_DM],'-','Color', 'r', 'LineWidth',2);





LEG = legend(sp1,[D DM LI],'Ice draft','DM','AM','Location','northwest' );
...
D1 = plot(t_sample,h_sample,'k')

dynamicDateTicks
AM1 = plot(sp3,sp1.XLim,[h_LI h_LI],'--','Color', 'r', 'LineWidth',2);
DM1 = plot(sp3,sp1.XLim,[h_DM h_DM],'-','Color', 'r', 'LineWidth',2);

LEG = legend(sp3,[D1  DM1 AM1],'Ice draft' ,'DM','AM');
